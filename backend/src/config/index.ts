...
export const config = {
  ...
  og: {
    ...
    storageUploadTaskSize: parseInt(process.env.OG_STORAGE_UPLOAD_TASK_SIZE || "8"),
    storageUploadTimeoutMs: parseInt(process.env.OG_STORAGE_UPLOAD_TIMEOUT_MS || "180000"),
    storageUploadNodeAttempts: parseInt(process.env.OG_STORAGE_UPLOAD_NODE_ATTEMPTS || "3"),
